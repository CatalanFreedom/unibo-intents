...
1) sudo python hotmboxes16-topo-2016-02-08.py  
'''
...
def defineNetwork():
  if len(sys.argv) < 2:
    print "Missing paramenter: python hotmboxes16-topo-2016-02-08.py <debug=1|0>"
    sys.exit()
    #commento
...
# ip='192.168.224.133',
  ...
  for switch in net.switches:
    switch.cmd('ovs-vsctl set-controller ' +  switch.name + ' tcp:192.168.56.11:6633')
