 ...
 */
@Command(scope = "byon", name = "configure-network", description = "Configure the gateways of the present network")
public class ConfigureGWsCommand extends AbstractShellCommand {

    @Override
    protected void execute() {
        NetworkService networkService = get(NetworkService.class);
        networkService.configureNetwork();
