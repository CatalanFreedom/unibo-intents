 ...
 */
@Command(scope = "byon", name = "show-unibo-network", description = "Show the topology of your Network")
public class ShowUNIBONetworkCommand extends AbstractShellCommand {

    @Override
    protected void execute() {
        NetworkService networkService = get(NetworkService.class);
        networkService.showUNIBONetwork();
